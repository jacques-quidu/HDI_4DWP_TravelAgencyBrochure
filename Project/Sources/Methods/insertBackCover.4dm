...
// Format title text
$oRange.range.styleSheet:="BackCover_Title"
...
$oRange.range.styleSheet:="BackCover_Text"
...
$section.section.backgroundImage:=flyerEnt.BackCover
...
$obPict.setAttributes({anchorSection: $section.section.sectionIndex; \
